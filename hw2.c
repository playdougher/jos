...
*/
  ...
  case '<':
    ...
    // Your code here ...
    close(rcmd->fd); //[xv6_book_P12]After the child closes ﬁle descriptor 0, open is guaranteed to use that ﬁle descriptor for the newly opened input.txt: 0 will be the smallest available ﬁle descriptor. Cat then executes with ﬁle descriptor 0 (standard input) referring to input.txt.
